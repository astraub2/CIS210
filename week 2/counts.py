...
def count_codes(majors_file):
    ...
    args:
        majors_file: this contains our list of majors. After etraction from
        the file we will alphabatice then slice and dice this
        list to recieve our final counts for each major.
    returns:
         none. This function prints the majors and their count.
